...
Page({
  ...
  data: {
    ...
    menuitems: [
      ...
      { text: '下拉刷新4', hint: '自定义下拉刷新4', url: '../list/list_refresh_c/index', icon: '../../images/home/home-test.png', tips: '', tap: '' },
      ...
      { text: '大转盘抽奖页面', hint: '搜索页面', url: '../lottery/index2/index', icon: '../../images/home/home-test.png', tips: '', tap: '' },
      { text: '九宫格抽奖页面', hint: '搜索页面', url: '../lottery/index/index', icon: '../../images/home/home-test.png', tips: '', tap: '' },
      { text: '文字语音转换', hint: '语音转文字、文字转语音', url: '../error/update', icon: '../../images/home/home-test.png', tips: '', tap: '' },
      { text: '图片转换', hint: '图片转ASCII字符图片', url: '../error/update', icon: '../../images/home/home-test.png', tips: '', tap: '' },
      { text: '聊天机器人', hint: '聊天机器人陪聊', url: '../imRobot/chat', icon: '../../images/home/home-test.png', tips: '', tap: '' }
    ],
